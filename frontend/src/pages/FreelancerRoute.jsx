...
// Guards freelancer-only pages (my proposals). Anyone not currently in
...
export default function FreelancerRoute() {
  ...
  useEffect(() => {
    ...
    if (blocked && !wasJustSwitched()) {
      showToast('That page is only available in Freelancer mode. Switch to Freelancer to manage your proposals.');
    }
  }, [blocked]);
