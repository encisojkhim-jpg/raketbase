    ...
    <>
      ...
      <div className="sidebar-wrapper" id="sidebar">
        ...
        <div className="flex-grow-1 overflow-y-auto mt-4">
          <div className="sidebar-menu-section">
            ...
            <ul className="sidebar-menu-list">
              ...
              <li className="sidebar-menu-item">
                <Link to={`/freelancer/${user.user_id || user.id}`} className={`sidebar-menu-link ${isOwnProfile ? 'active' : ''}`}>
        ...
        <div className="sidebar-profile">
          <img src={user.avatar_url || DEFAULT_AVATAR} alt="Profile" className="sidebar-profile-img" />
      ...
      <div className="main-wrapper">
        <header className="navbar-custom">
          <div className="navbar-left">
            <button className="sidebar-toggle-btn me-2" id="sidebar-toggle"><i className="bi bi-list"></i></button>
          ...
          <div className="navbar-actions">
            <div className="dropdown ms-2">
              <button className="navbar-profile-btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img src={user.avatar_url || DEFAULT_AVATAR} alt="Profile" className="navbar-profile-img" />
              ...
              <ul className="dropdown-menu dropdown-menu-end dropdown-menu-profile">
                ...
                <li><Link className="dropdown-item" to={`/freelancer/${user.user_id}`}><i className="bi bi-person"></i> My Profile</Link></li>
